...
$.MT_TOKEN_WAP_KEY = 'MT_TOKEN_WAP';
$.MT_TOKEN_WAP = $.getdata($.MT_TOKEN_WAP_KEY) || '';
...
!(async () => {
  ...
  function GetCookie() {
    if ($request && $request.headers) {
      ...
      if ($request.headers['Cookie'] && $request.headers['Cookie'].includes('MT-Token-Wap')) {
      ...
      if ($.MT_TOKENS && $.MT_TOKEN_WAP) {
        $.log(`MT-Device-ID,MT-Token,MT-Token-Wap:\n${$.MT_TOKENS + ',' + $.MT_TOKEN_WAP}`);
      }
    }
  }
