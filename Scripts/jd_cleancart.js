...
[task_local]
#清空购物车
35 6-21/3 * * * jd_cleancart.js, tag=清空购物车, img-url=https://raw.githubusercontent.com/Orz-3/mini/master/Color/jd.png, enabled=true
===========Loon============
[Script]
cron "35 6-21/3 * * *" script-path=jd_cleancart.js,tag=清空购物车
============Surge=============
清空购物车 = type=cron,cronexp="35 6-21/3 * * *",wake-system=1,timeout=3600,script-path=jd_cleancart.js
===========小火箭========
