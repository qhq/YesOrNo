...
cat /etc/hosts | egrep -qPi "^\d.+?raw.githubusercontent.com"
if [ $? -ne 0 ]; then
...
author_list="qhqcz Sunert yangtingxiao longzhuzhu Andy moposmall panghu star261 Wenmoux JDHelloWorld passerby SuperManito cdle"
...
## 删除过期活动
echo -e "+-------------- 失效/过期脚本 ---------------+"
js_List="star261_jd_star_shop JDHelloWorld_jd_cfd_SlotMachine ddo_pk qhqcz_jd_necklace qhqcz_jd_superBrand  Wenmoux_jd_superBrand JDHelloWorld_jd_joy_new panghu_jd_hwsx jd_enen jd_joy_reward_new songyangzz_jd_joy cdle_jxzpk"
for js_item in $js_List; do
