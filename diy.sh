...
if [ ${iCan} = "true" ]; then
    ...
    my_scripts_list_12="jd_cfd.js jd_dreamFactory.js jd_fruit.js jd_health.js jd_pet.js jd_plantBean.js jd_jdfactory.js jd_sgmh.js jd_api_test.js jd_joy.js JDJRValidator.js"
