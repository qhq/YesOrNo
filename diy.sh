...
## 注释指定活动
echo -e "========== 暂时停用脚本 =========="
js_List="jd_cfd jd_dreamFactory jd_fruit jd_health jd_pet jd_plantBean jd_carnivalcity jd_jdfactory jd_sgmh jd_star_shop jd_jxmc jd_zoo jd_zooCollect jd_xtg longzhuzhu_long_super_redrain longzhuzhu_long_half_redrain jd_jxlhb"
