...
if [ ${iCan} = "true" ]; then
    ...
    ############################## 作者脚本名称（必填）##############################
    # 将相应作者的脚本填写到以下变量中
    my_scripts_list_1="91wii.js jd_live_lottery_social.js post_code.js jd_bean_change.js jd_necklace.js jd_jxsign.js jd_speed.js jd_joy.js JDJRValidator.js"
