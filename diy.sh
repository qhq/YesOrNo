...
## 注释指定活动
js_List="jd_bean_change qhqcz_jd_enen passerby_jd_fruit2 passerby_jd_dreamFactory2 jd_big_winner jd_star_shop jd_speed_redEnvelope jd_joy_park jd_EsportsManager qhqcz_jd_cleancart qhqcz_jd_unsubscriLive qhqcz_getName qhqcz_jd_jxsign"
if [ -n "$js_List" ]; then
echo -e "+--------------- 暂时停用脚本 ---------------+"
